...
export const LITERARY_QUESTS={
 ...
 yueyang:{name:'岳陽樓',title:'先天下之憂',author:'范仲淹〈岳陽樓記〉',note:'依文保照片參照現存清代形制：黃瓦、三層飛簷與盔頂。四格縮尺模型，非宋樓原貌或測繪級復原。',source:'https://www.yueyang.gov.cn/ml/content_51560.html',requirement:'完成一座民居、一座作坊及一座義倉',steps:[
 ...
 printing:{name:'活字印書坊',title:'讓文章走進千家',author:'沈括《夢溪筆談》〈活板〉',note:'依活字工序製作的教學工坊；畢昇是技術人物，沈括是記錄者。落成後工匠使用紙墨印書，推車配送至書肆販售。',source:'https://zh.wikisource.org/zh-hant/夢溪筆談/卷十八',requirement:'完成一座作坊及一座村塾、鎮學、書院或縣學',steps:[
...
export function unlockQuest(t,id){
 ...
 if(!Object.hasOwn(LITERARY_QUESTS,id)||e.step!==q.steps.length||!activitiesDone(t,id)||requirements(t,id).some(r=>!r.ok))return false;
