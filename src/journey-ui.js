import {sessionBaseline,sessionSummaryHTML} from './journey-summary.js';
...
export function installJourneyUI({getTown,change,toast,endObservation}){
 let focusedResident=null,baseline=sessionBaseline(getTown());
 ...
 content.onclick=e=>{
  if(e.target.closest('[data-end-observation]')){dialog.close();endObservation();return;}
 ...
 return {open,resetSession(){baseline=sessionBaseline(getTown());}};
}
