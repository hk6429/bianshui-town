...
export function goodsModel(good){
 ...
 if(good==='ceramics'){add(g,new THREE.CylinderGeometry(.12,.19,.29,8),0x7eaaa0,0,.18,0);add(g,new THREE.TorusGeometry(.105,.023,4,10),0x638c83,0,.33,0).rotation.x=Math.PI/2;}
