...
export function validateSave(data){const d=cloneJSON(data);obj(schemas)(d,'根');for(const [version,key]of [[2,'life'],[3,'stories'],[4,'weather'],[4,'economy'],[6,'literati'],[7,'publicWorks'],[8,'market']])if(d.version>=version&&!Object.hasOwn(d,key))fail(key,'此版本缺少必要欄位');references(d);return d;}
