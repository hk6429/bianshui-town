...
const journey=obj({reading:opt(reading),townName:opt(placeName),bookmarks:opt(arr(obj({building:id,label:placeName}),16)),construction:opt(construction),commissions:opt(arr(commission,64)),version:en([1]),enabled:bool,vision:en(['home','craft','culture']),guide:obj({stage:num(0,4,true),skipped:bool}),observedResident:bool,claimed:arr(en(['settlement','craft','culture']),3),shortGoal:en(['observe','home'])});
