...
const construction=obj({targets:arr(id,143,1),at:num(),label:str,before:obj({buildings:num(0,143,true),users:num(0,1144,true),activities:arr(obj({name:str,count:num(1,1144,true)}),32)})});
