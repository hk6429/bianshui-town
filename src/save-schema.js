...
const journey=obj({construction:opt(construction),commissions:opt(arr(commission,64)),version:en([1]),enabled:bool,vision:en(['home','craft','culture']),guide:obj({stage:num(0,4,true),skipped:bool}),observedResident:bool,claimed:arr(en(['settlement','craft','culture']),3),shortGoal:en(['observe','home'])});
