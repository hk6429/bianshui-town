...
export function logistics(t){const level=t.city.logisticsLevel||1;return {level,porters:level+1,oxen:level,porterLoad:level,oxLoad:level*2+1,upkeep:(level-1)*LOGISTICS_UPKEEP,upgradeCost:level<MAX_LOGISTICS_LEVEL?level*45000:0};}
