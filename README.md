...
「營造與工具 → 宋韻任務」提供岳陽樓、開封府與活字印書坊三條任務，每條有三段閱讀挑戰、提示、選填短箋與城鎮前置。完成後解鎖四格圖樣；建造與五級升級沿用鎮庫及空地規則。任務進度隨城市存檔保存，舊檔不需重置。三座建築有獨立模型與逐級配套，岳陽樓目前為文學意象，並非歷史精確復原。完整災後情境、街頭證人查訪、書籍商品與其餘七條任務尚待後續。

驗證與範圍見 [第一批交接](docs/literary-quests-handoff.md)。
